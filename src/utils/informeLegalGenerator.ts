...
export interface RiesgoInforme {
  ...
  nivel: 'CR√çTICO' | 'ALTO' | 'MEDIO' | 'BAJO'
...
function titleCell(titulo: string, proyecto: string, parteA: string, parteB: string) {
  return new TableCell({
    ...
    children: [
      new Paragraph({
        children: [run('AN√ÅLISIS JUR√çDICO DEL CONTRATO DE SERVICIOS', { bold: true, size: 13, color: C.white, allCaps: true })],
...
function tablaRiesgos(riesgos: RiesgoInforme[]) {
  const headerRow = new TableRow({
    ...
    children: [
      ['CL√ÅUSULA / TEMA', 20],
      ['RIESGO JUR√çDICO / OPERACIONAL', 50],
      ['NIVEL', 15],
      ['PARTE AFECTADA', 15],
...
function tablaResumenEjecutivo(data: InformeLegalData) {
  const rows = [
    ...
    ['Naturaleza Jur√≠dica', data.naturalezaJuridica],
  ]
  return new Table({
    width: { size: 100, type: WidthType.PERCENTAGE },
    borders: {
  ...
  const doc = new Document({
    ...
    sections: [{
          ...
          children: [
            new Paragraph({
              children: [
                ...
                run('An√°lisis Jur√≠dico ‚?? Derecho Chileno', { size: 8, color: C.slate, italics: true }),
              ],
          ...
          children: [
            new Paragraph({
              children: [
                ...
                run('Basado en Ordenamiento Jur√≠dico Chileno  ¬∑  ', { size: 8, color: C.slate, italics: true }),
                run('P√°gina ', { size: 8, color: C.slate }),
      ...
      children: [
        ...
        new Paragraph({
          children: [run('Identificaci√≥n de las Partes e Informaci√≥n General', { bold: true, size: 10, color: C.navy })],
        ...
        new Paragraph({
          children: [run('Observaci√≥n General:', { bold: true, size: 10, color: C.navy })],
        ...
        sectionTitle('I', 'Aspectos Generales y Naturaleza Jur√≠dica'),
        ...bodyText(data.aspectosGenerales),

        // ‚??‚?? II. OBLIGACIONES ‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??
        sectionTitle('II', 'An√°lisis de Obligaciones de las Partes'),
        ...
        // ‚??‚?? III. CONDICIONES ECON√?MICAS ‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??
        sectionTitle('III', 'Condiciones Econ√≥micas y Sistema de Pago'),
        ...bodyText(data.condicionesEconomicas),

        // ‚??‚?? IV. CL√ÅUSULAS ESPECIALES ‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??
        sectionTitle('IV', 'An√°lisis de Cl√°usulas Especiales Cr√≠ticas'),
        ...
        // ‚??‚?? VI. T√?RMINO ANTICIPADO ‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??
        sectionTitle('VI', 'T√©rmino Anticipado e Indemnizaciones'),
        ...bodyText(data.terminoAnticipado),

        // ‚??‚?? VII. RESOLUCI√?N DE CONFLICTOS ‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??
        sectionTitle('VII', 'Cl√°usulas de Resoluci√≥n de Conflictos'),
        ...bodyText(data.resolucionConflictos),

        // ‚??‚?? VIII. ASPECTOS PROCESALES ‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??
        sectionTitle('VIII', 'Aspectos Procesales y Garant√≠as'),
        ...bodyText(data.aspectosProcesales),

        // ‚??‚?? IX. RIESGOS ‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??‚??
        sectionTitle('IX', 'Riesgos y Observaciones Cr√≠ticas'),
        emptyLine(),
        ...
        emptyLine(),
        new Paragraph({
          children: [run(`${data.ciudad}, a la fecha de emisi√≥n del presente informe.`, { size: 10, color: C.gray, italics: true })],
          alignment: AlignmentType.RIGHT,
        ...
        new Paragraph({
          children: [run(`An√°lisis generado con ${data.modeloIA} ¬∑ Derecho Chileno Vigente`, { size: 8, color: C.slate, italics: true })],
          alignment: AlignmentType.RIGHT,
          spacing: { before: 0, after: 40 },
        }),
        new Paragraph({
          children: [run(
            'AVISO LEGAL: Este informe es un an√°lisis automatizado generado por inteligencia artificial con fines informativos. No constituye asesor√≠a legal profesional. Siempre consulte a un abogado habilitado para asuntos jur√≠dicos concretos.',
...
export async function downloadInformeLegal(data: InformeLegalData) {
  ...
  a.href = url
  a.download = `LEXARA_InformeJuridico_${data.parteA.replace(/\s+/g, '_').replace(/[^a-zA-Z0-9_·ÈÌÛ˙Ò¸]/gi, '').substring(0, 24) || 'contrato'}_${new Date().toISOString().split('T')[0]}.docx`
